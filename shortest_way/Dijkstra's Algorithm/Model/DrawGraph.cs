...
namespace Dijkstra_s_Algorithm
{
    ...
    class DrawGraph
    {
        ...
        public DrawGraph(int width, int height)
        {
            ...
            redPen.Width = 2;
            darkGoldPen = new Pen(Color.Black);//DarkGoldenrod
            darkGoldPen.Width = 2;
        ...
        public void drawEdge(Vertex V1, Vertex V2, Edge edge, List<Edge> Edges, int numberE, byte orientation)
        {
            ...
            if (orientation == 1)
                DrawArrow(Start, End, blackPen); // Цвет линии!
            else
                gr.DrawLine(darkGoldPen, Start, End);
            double ugol = Math.Atan2(V1.x - V2.x - R, V1.y - V2.y - R);
            Random rand = new Random();
            point = new PointF((V1.x + V2.x) / 2 + rand.Next(30), (V1.y + V2.y) / 2+ rand.Next(30));//
        ...
        {
            AdjustableArrowCap bigArrow = new AdjustableArrowCap(14, 14); // R - 5
